  ...
  function fb(b, c, e) {
    ...
    if (
      ...
      if (
        ...
        return g;
      (f = i && (l.boxSizingReliable() || g === b.style[c])), (g =
        parseFloat(g) || 0);
    }
    ...
    propHooks: {
      tabIndex: {
        get: function(a) {
          ...
          return b
            ? parseInt(b, 10)
            : yb.test(a.nodeName) || (zb.test(a.nodeName) && a.href) ? 0 : -1;
        },
      },
    },
  ...
  n.extend({
    ...
    ajax: function(b, c) {
      ...
      (i = n.event && l.global), i &&
        ...
        n.event.trigger(
          'ajaxStart'
        ), (l.type = l.type.toUpperCase()), (l.hasContent = !Kb.test(
        l.type
      ...
      ? (
          ...
          d.always(function() {
            void 0 === f
              ...
              : (a[
                  e
                ] = f), b[e] && ((b.jsonpCallback = c.jsonpCallback), ic.push(e)), g && n.isFunction(f) && f(g[0]), (g = f = void 0);
          }),
          'script'
        )
      : void 0;
